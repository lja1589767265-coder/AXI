...
新规范从 A5 及后续章节开始执行，并已用于重制 A1、A2 和 A3。A1、A3 按单章需求采用全文中英双语对照；A2 采用“纯中文正文＋关键英文原句”的形式。A3 的旧版学习导读另行归档保留。

除另有单章要求外，翻译文档采用“纯中文正文＋关键英文原句”的形式；A1、A3 当前采用全文中英双语对照。正文以适用版本的 Arm 官方规范为唯一内容依据，完整保留原文信息和出现顺序，不增加原文没有的教学讲解、案例、自测题、总结或结论。
...
A1、A3 当前采用全文中英双语对照。除非另有明确要求，其他章节（包括 A2）仍采用第 5.4 节的“中文正文＋关键英文原句”形式。
...
A1、A3 在 README 中标记为“全文双语稿”，A2 标记为“忠实翻译稿”。从 A5 开始的新文档必须遵守本规范。
